<?php
    ...
    if($user && isset($_SESSION['uid1']) && isset($_SESSION['uid2'])){
        try{
            ...
            if(imagecopymerge($originalImage, $u1, 35, 65, 0, 0, imagesx($u1), imagesy($u1), 100) && imagecopymerge($originalImage,$u2, 777, 235,0, 0, imagesx($u2), imagesy($u2), 100)){
                ...
                if(imagecopymerge($originalImage, $n1, 35, 17, 0, 0, imagesx($n1), imagesy($n1), 100) && imagecopymerge($originalImage,$n2, 497, 360, 0, 0, imagesx($n2), imagesy($n2), 100)){
